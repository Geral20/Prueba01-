public class ContainerRect {
    ...
    //  TO STRING PARA MOsTAR DATOs

    public String toString() {

        System.out.println("Rectangulos	Coordenada			Distancia	Area");
        for (int i = 0; i < n; i++) {
            System.out.println("     " + (i + 1) + "		" + arrRectangulos[i].toString() +
                    "	" + Math.round(arrDistancias[i] * 1000d) / 1000d + "		"
                    + Math.round(arrAreas[i] * 100d) / 100d);
        }
        return " ";
    }
}
